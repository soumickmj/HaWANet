...
class Canvas(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.drawingPTColor = QColor(255,255,255)
        self.line = Shape(line_color=self.drawingLineColor)
        self.prevPoint = QPointF()
        self.offsets = QPointF(), QPointF()
        self.scale = 1.0
        self.labelFontSize = 2
        self.pixmap = QPixmap()
        self.visible = {}
        self._hideBackround = False
        self.hideBackround = False
        self.show_PTcloud = False #pointcloud
        self.points=[] #point
        self.hShape = None
        self.hVertex = None
    ...
    def finalise(self):
        ...
        # print(f'self.shapes Finalize: {self.shapes}')

        self.final_shapes = self.shapes
    ...
    def loadShapes(self, shapes):
        ...
        self.current = None
        self.repaint()
        # print(f'self.shapes Load shapes: {self.shapes}')
        return self.shapes
