    ...
    def paint(self, painter):
        if self.points:
            ...
            if self.paintLabel:
                min_x = sys.maxsize                
                min_y = sys.maxsize
                min_y_label = int(1 * self.labelFontSize)
                ...
                if min_x != sys.maxsize and min_y != sys.maxsize:
                    ...
                    if(min_y < min_y_label):
                        min_y += min_y_label
                    painter.drawText(min_x, min_y, self.label + str(self.test_distance))
                    #print(self.test_distance) 
                    #print(self.test_array)
                    #painter.drawText(min_x+200, min_y, "test")
            #print(self.test_distance)        
            if self.fill:
